...
public class FreeDbJdbcDaoImpl extends NamedParameterJdbcDaoSupport implements FreeDbDao {
  ...
  public List<Disc> getDiscsById(String cddbId) {
    final String sql =
        "SELECT `discs`.`id` FROM `discs`, `cddb_ids` "
    ...
    List<Integer> result =
        this.getNamedParameterJdbcTemplate().queryForList(sql, parms, Integer.class);
  ...
  public List<Disc> getAllDiscs() {
    ...
    List<Integer> result =
        this.getNamedParameterJdbcTemplate()
            .queryForList(sql, (SqlParameterSource) null, Integer.class);
    List<Disc> discs = new ArrayList<Disc>();
    for (Integer id : result) {
      discs.add(getDisc(id));
    }
