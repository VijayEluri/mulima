...
public interface Library {
	...
	/**
	 * Gets the audio format of the files in
	 * this library.
	...
	/**
	 * Gets the library album in this library
	 * that has the specified ID.  This will
	 * return null if the album could not be found.
	...
	/**
	 * Gets the library album in this library that was
	 * sourced from the parameter.  If no album in this
	 * library was sourced from the parameter, a new one
	 * will be created.
	 ...
	 * sourced from the parameter.  If no album in this
	 * library was sourced from the parameter, a new one
	 * will only be created if {@code createIfNotFound} is
	 * {@code true}.  Otherwise {@code null} will be returned.
	 * @param source the source album
	 * @param createIfNotFound {@code true} if a new album should
	 * be created, if one is not found.  {@code false} otherwise
