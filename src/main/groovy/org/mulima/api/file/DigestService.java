...
public interface DigestService {
	/**
	 * Creates a digest representing the current
	 * state of the files in the given library
	 * album.
	 * @param libAlbum the library album to create
	 * a digest for
	...
	/**
	 * Reads the library album's source digest
	 * from a file.
	 * @param libAlbum the library album
	...
	/**
	 * Writes the digest and source digest files
