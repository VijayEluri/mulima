...
public class TempDir implements FileHolder {
	...
	/**
	 * Creates a temporary directory as a child of the
	 * specified temp dir.  The created directory will
	 * have a random name.
	...
	/**
	 * Creates a temporary directory as a child of the
	 * specified dir.  The created directory will
	...
	/**
	 * Creates a new temporary directory as a
	 * child of this one.
	...
	/**
	 * Creates a new temporary directory as a
	 * child of this one, with the specified
	 * name.
