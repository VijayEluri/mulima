...
import z.org.mulima.api.library.LibraryAlbumFactory;
...
public class DefaultLibraryAlbumFactory implements LibraryAlbumFactory {
	...
	@Override
	public <T extends LibraryAlbum> T newAlbum(Library<T> lib, T libAlbum) {
		String album = null;
		...
		Album album = libAlbum.getAlbum();
		if (DiscLibraryAlbum.class.isAssignableFrom(libAlbum.getClass())) {
			DiscLibraryAlbum discAlbum = new DiscLibraryAlbum(context, lib, id, dir, album);
