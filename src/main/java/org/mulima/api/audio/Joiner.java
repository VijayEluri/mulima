...
public interface Joiner {
	 ...
	 * @throws ProcessExecutionException if there is a problem joining the files
	 */
	JoinerResult join(List<AudioFile> files, AudioFile dest) throws ProcessExecutionException;
