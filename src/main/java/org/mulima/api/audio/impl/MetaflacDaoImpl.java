...
import org.mulima.api.meta.impl.VorbisTag;
...
public class MetaflacDaoImpl implements Tagger {
	 ...
	 */
	@Override
	public TaggerResult write(AudioFile file, Track meta) throws ProcessExecutionException {
		return new Writer(file, meta).call();
	}
	 ...
	 */
	@Override
	public TaggerResult read(AudioFile file) throws ProcessExecutionException {
		return new Reader(file).call();
	}
	...
	private class Writer implements Callable<TaggerResult> {
		 ...
		 */
		@Override
		public TaggerResult call() throws ProcessExecutionException {
