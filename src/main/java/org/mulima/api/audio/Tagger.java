...
public interface Tagger {
	 ...
	 * @throws ProcessExecutionException if there is a problem tagging
	 */
	TaggerResult write(AudioFile file, Track track) throws ProcessExecutionException;
	
	/**
	 * Executes a read operation immediately.
	 * @param file the file to read from
	 * @return a tagger result
	 * @throws ProcessExecutionException if there is a problem reading
	 */
	TaggerResult read(AudioFile file) throws ProcessExecutionException;
