 ...
 */
package org.mulima.api.audio.util;
...
public class CodecCaller implements Callable<CodecResult> {
	 ...
	 * @throws ProcessExecutionException if there is a problem with the codec
	 */
	@Override
	public CodecResult call() throws ProcessExecutionException {
