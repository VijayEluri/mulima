...
public class CueSheet extends AbstractMetadata {
	...
	@Override
	public int hashCode() {
		return ("" + Integer.valueOf(getNum()).hashCode() + getMap().hashCode() + getTracks().hashCode()).hashCode();
	}
	
	@Override
	public String toString() {
		return "[num: " + getNum() + ", tags: " + getMap() + ", tracks:" + getTracks() + "]";
	}
	...
	public static class Track extends AbstractMetadata {
		...
		@Override
		public String toString() {
			return "[num: " + getNum() + ", tags: " + getMap() + ", indices: " + getIndices();
		}
	}
