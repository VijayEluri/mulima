...
public class MetadataController implements Initializable {
  @FXML
  private TreeView<Metadata> tree;

  @FXML
  private TextField sourceFile;
  @FXML
  private TextField artworkFile;
  @FXML
  private TextField audioFile;

  @FXML
  private TableView<CuePoint> cues;
  @FXML
  private TableColumn<CuePoint, Integer> index;
  @FXML
  private TableColumn<CuePoint, String> time;

  @FXML
  private TableView<Map<String, String>> tags;
  @FXML
  private TableColumn<Map<String, String>, String> tagName;
  @FXML
  private TableColumn<Map<String, String>, String> tagValue;
  ...
  public void initialize(URL Location, ResourceBundle resources) {
    ...
    var cellFactory = TextFieldListCell.forListView(new StringConverter<Metadata>() {
      @Override
      public String toString(Metadata object) {
      ...
      @Override
      public Metadata fromString(String string) {
    ...
    // .flatMap(entry -> entry.getValue().stream().map(value -> Map.of("name", entry.getKey(), "value",
    // value)))
